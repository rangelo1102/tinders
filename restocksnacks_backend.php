...
//check stock
$stockQuery = "SELECT amount_product FROM products_snacks WHERE name_product= '".$oldprodname."'";
...
if ($newprodname!=""&&$newprodprice!=0&&$newprodqty!=0&&$newprodcost!=0){
	...
	$newprodquery="INSERT INTO products_snacks (name_product, amount_product, price_product, production_cost) 
