...
namespace Tinders
{
    #region Products_snacks
    public class Products_snacks
    {
        ...
        #endregion
        #region Constructors
        public Products_snacks() { }
        public Products_snacks(string name_product, int amount_product, int price_product, int sold_product, int revenue)
        {
