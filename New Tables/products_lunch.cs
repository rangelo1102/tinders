...
namespace Tinders
{
    #region Products_lunch
    public class Products_lunch
    {
        ...
        #endregion
        #region Constructors
        public Products_lunch() { }
        public Products_lunch(string name_product, int amount_product, int price_product, int sold_product, int revenue)
        {
